...
const initialData = () => {
  ...
  return { pictures, users }; //return an object with the pictures array and the users array
}; // end of initialData

export default initialData;

//pictures: [] זה מערך של אובייקטים מה CLASS PICTURE
// ? למה שמנו סוגריים מסולסלים ברטורנ
// ? כי זה פונקציה שמחזירה אובייקט ואז נכנס לתוך האובייקט ונגיע למערך של האובייקטים
